...
@csrf
@method('PUT')
<input type="hidden" name="icustomerlegal" value="1">
<!-- ОДНА СТРОКА ФОРМЫ -->
    <div class="container-fluid lk_formContainer">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-6">
                    <input type="text" name="ccustomernamef" value="{{ $dbco_customer->ccustomernamef }}" id="ccustomernamef" class="form-control m_fccustomernameiormControl" placeholder="{{__('Фамилия')}}" style="max-width: 100%;"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid lk_formContainer">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-6">
                    <input type="text" name="ccustomernamef" value="{{ $dbco_customer->ccustomernamei }}" id="ccustomernamei" class="form-control m_formControl" placeholder="{{__('Имя')}}" style="max-width: 100%;"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid lk_formContainer">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-6">
                    <input type="text" name="ccustomerposition" value="{{ $dbco_customer->ccustomerposition }}" id="ccustomerposition" class="form-control m_formControl" placeholder="{{__('Должность')}}" style="max-width: 100%;"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid lk_formContainer">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-6">
                    <input type="text" name="ccustomercompany" value="{{ $dbco_customer->ccustomercompany }}" id="ccustomercompany" class="form-control m_formControl" placeholder="{{__('Наименование организации')}}" style="max-width: 100%;"/>
                </div>
            </div>
        </div>
    </div>
